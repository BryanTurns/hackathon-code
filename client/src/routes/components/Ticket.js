  ...
  return (
    <div className="w-3/12 inline-block m-5 text-center bg-gray-700 rounded-3xl">
      ...
      <button
        ...
        className="border-black bg-gray-200 my-3 inline-block rounded-lg p-3 text-3xl border-2 border-solid  text-black  hover:text-white hover:bg-gray-600 transition ease-out duration-300 active:text-blue-800"
      >
        Get Ticket
      </button>
    </div>
